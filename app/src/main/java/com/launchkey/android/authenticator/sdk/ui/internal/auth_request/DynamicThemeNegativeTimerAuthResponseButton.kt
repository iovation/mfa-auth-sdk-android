...
class DynamicThemeNegativeTimerAuthResponseButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : TimerAuthResponseButton(context, attrs, defStyleAttr) {
    init {
        val tarbUiProp = AuthenticatorUIManager.instance.config.themeObj().arbNegative
